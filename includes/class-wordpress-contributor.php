...
class Wordpress_Contributor {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wordpress_Contributor_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Wordpress_Contributor_Loader. Orchestrates the hooks of the plugin.
	 * - Wordpress_Contributor_i18n. Defines internationalization functionality.
	 * - Wordpress_Contributor_Admin. Defines all hooks for the admin area.
	 * - Wordpress_Contributor_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wordpress_Contributor_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wordpress_Contributor_Loader    Orchestrates the hooks of the plugin.
	 */
